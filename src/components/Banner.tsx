...
const Banner = () => {
  return (
    ...
    <section className="container mx-auto flex  flex-row justify-between items-center gap-8  px-6 py-10 ">
      <div className=" text-left">
        ...
        <p className="pb-6">
          ...
          compare them side by side, and put together the stack that fits <br className="hidden lg:block" />
          your next project.
        </p>
      ...
      <div>
        <img src={banner} alt="" className="w-64 sm:w-80 lg:w-auto" />
      </div>
    </section>
